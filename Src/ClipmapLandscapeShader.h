...
protected:
    /// Uniforms
    GLuint uMVP, uBrushPosition, uBrushScale, uBrushTexture, uTBO, uClipmapSizeX, uClipmapSizeY, uLandscapeVertexOffset, uWireframeColor, uBrushColor, uTestOffsetY, uTestOffsetX, uClipmapScale, uClipmapMode, uClipmapPartOffset, uLandscapeTexture;
